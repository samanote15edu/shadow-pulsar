export const Templates = {
  ...
  Onboarding: {
    ...
    firstProductUnitPrompt: "⚖️ ¿Cómo vendes este producto?\n\n1️⃣ Por Pieza / Unidad (Bolsas, Latas)\n2️⃣ Por Kilogramo (kg)\n3️⃣ Por Gramo (gr)\n4️⃣ Por Litro (lt)\n5️⃣ Por Caja\n6️⃣ Por Paquete\n\n*(Responde con el número)*",
    firstProductQtyPrompt: (name: string, unitStr: string = "unidades") => `📦 ¿Cuántos **${unitStr}** de "${name}" tienes ahora mismo?`,
