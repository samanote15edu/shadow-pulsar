...
DROP POLICY IF EXISTS "Lectura pública de logs" ON activity_logs;
DROP POLICY IF EXISTS "Lectura pública de evidencias" ON activity_evidences;

-- Public read for reporting to support Magic Links
